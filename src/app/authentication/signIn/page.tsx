...
const SignIn = () => {
  ...
  return (
    <main className="flex h-[calc(100vh-100px)]  mt-[130px] mb-[200px]  relative">
      <div className="flex-1 flex items-center justify-center">
        <div className="half-page-background-container">
          <Image
            ...
            width={920}
            height={800}
            className="object-cover object-left pb-4 "
            priority
          />
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-white">
        <div className="w-100">
          <h1 className="text-5xl mb-12">{t('login')}</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
           ...
           <Link href="/home"> <button
            ...
            <Link href="authentication/signUp" className="text-red-600 hover:underline ml-23">{t('forgetPassword')}</Link>
          </form>
        </div>
      </div>
    </main>
